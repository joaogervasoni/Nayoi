...
module.exports = class {
    ...
    async run() {
        ...
        this.bot.logger.check('Carregadas em todos os servidores', 'lang');
        this.bot.logger.check(`${this.bot.user.username} esta Online em ${this.bot.guilds.cache.size} servidores`, 'online');
